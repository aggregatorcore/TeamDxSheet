    ...
    >
      ...
      >
        ...
        <div className="p-4 space-y-3 max-h-[70vh] overflow-y-auto">
              ...
              <div className="space-y-2">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => { setAppliedCountry(e.target.value); setError(null); }}
                    className="w-full rounded-lg border border-sky-200 bg-white px-2.5 py-2 text-sm text-slate-900 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500/20"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => { setConsultancyName(e.target.value); setError(null); }}
                    placeholder="e.g. ABC Consultants"
                    className="w-full rounded-lg border border-sky-200 bg-white px-2.5 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500/20"
                  />
                </div>
                <div>
                  ...
                  <input
                    type="text"
                    value={charges}
                    onChange={(e) => { setCharges(e.target.value); setError(null); }}
          ...
          {/* Trust issue - fraud question + our trust issue note */}
          {isTrustIssue && (
            <div className="space-y-3">
              <div className="rounded-lg border border-rose-200 bg-rose-50/60 p-3 space-y-3">
                ...
                <div className="flex gap-2">
                  <button
                    type="button"
                    onClick={() => { setTrustIssueFraud("yes"); setError(null); }}
                    className={`flex-1 rounded-lg px-3 py-2 text-sm font-medium transition-colors ${
                      trustIssueFraud === "yes"
                        ? "border-2 border-rose-500 bg-rose-100 text-rose-900 ring-2 ring-rose-500/30"
                  ...
                  <button
                    type="button"
                    onClick={() => { setTrustIssueFraud("no"); setTrustIssueFraudCountry(""); setTrustIssueFraudAmount(""); setError(null); }}
                    className={`flex-1 rounded-lg px-3 py-2 text-sm font-medium transition-colors ${
                      trustIssueFraud === "no"
                        ? "border-2 border-rose-500 bg-rose-100 text-rose-900 ring-2 ring-rose-500/30"
                        : "border border-rose-200 bg-white text-slate-700 hover:bg-rose-50"
                ...
                {trustIssueFraud === "yes" && (
                  <div className="grid gap-2 sm:grid-cols-2 pt-2 border-t border-rose-200">
                    <div>
                      ...
                      <select
                        value={trustIssueFraudCountry}
                        onChange={(e) => { setTrustIssueFraudCountry(e.target.value); setError(null); }}
                        className="w-full rounded-lg border border-rose-200 bg-white px-2.5 py-2 text-sm text-slate-900 focus:border-rose-500 focus:outline-none focus:ring-2 focus:ring-rose-500/20"
                      >
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={trustIssueFraudAmount}
                        onChange={(e) => { setTrustIssueFraudAmount(e.target.value); setError(null); }}
                        placeholder="e.g. 50,000"
                        className="w-full rounded-lg border border-rose-200 bg-white px-2.5 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:border-rose-500 focus:outline-none focus:ring-2 focus:ring-rose-500/20"
                      />
                    </div>
                  </div>
                )}
              ...
              <div className="rounded-lg border border-rose-200 bg-rose-50/40 p-3">
                ...
                <textarea
                  value={trustIssueNote}
                  onChange={(e) => { setTrustIssueNote(e.target.value); setError(null); }}
                  placeholder="Describe the trust issue..."
                  rows={2}
                  className="w-full rounded-lg border border-rose-200 bg-white px-2.5 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:border-rose-500 focus:outline-none focus:ring-2 focus:ring-rose-500/20 resize-none"
                />
              </div>
            </div>
          )}

          {/* Client location too far - state + note */}
            ...
            <div className="rounded-lg border border-emerald-200 bg-emerald-50/60 p-3 space-y-3">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => { setClientLocation(e.target.value); setError(null); }}
                  className="w-full rounded-lg border border-emerald-200 bg-white px-2.5 py-2 text-sm text-slate-900 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
                >
              ...
              <div>
                ...
                <textarea
                  value={clientLocationNote}
                  onChange={(e) => { setClientLocationNote(e.target.value); setError(null); }}
                  placeholder="Additional details..."
                  rows={2}
                  className="w-full rounded-lg border border-emerald-200 bg-white px-2.5 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 resize-none"
                />
              </div>
            </div>
          )}
              ...
              <div className="grid gap-2 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-amber-200 bg-white px-2.5 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/20"
                  />
                </div>
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => { setPreferredCountry(e.target.value); setError(null); }}
                    className="w-full rounded-lg border border-amber-200 bg-white px-2.5 py-2 text-sm text-slate-900 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/20"
                  >
                    <option value="">Select</option>
                    {Object.entries(PREFERRED_COUNTRIES).map(([category, countries]) => (
                      <optgroup key={category} label={category}>
          ...
          {isOther && (
            <div>
              <label className="mb-1 block text-xs font-medium text-slate-700">
                Please specify <span className="text-slate-500 font-normal">(min {NOT_INTERESTED_OTHER_MIN_CHARS} chars)</span>
              </label>
              <textarea
                value={otherText}
                ...
                rows={2}
                className="w-full rounded-lg border border-slate-200 bg-white px-2.5 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:border-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-500/20 resize-none"
              />
              <p className={`mt-1 text-xs ${otherText.length >= NOT_INTERESTED_OTHER_MIN_CHARS ? "text-emerald-600" : "text-slate-500"}`}>
                {otherText.length} / {NOT_INTERESTED_OTHER_MIN_CHARS}
              </p>
            </div>
          )}
          ...
          <div className="flex gap-2 pt-0">
            ...
            <button
              ...
              className="flex-1 rounded-lg bg-slate-800 px-3 py-2 text-sm font-medium text-white hover:bg-slate-900 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
